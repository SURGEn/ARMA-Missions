...
class loadouts
{
	...
	class B_Soldier_TL_F
	{
		...
		linkedItems[] = {"ItemMap", "ItemCompass", "ItemWatch", "ItemRadio", "ItemMicroDAGR"}; // Linked items for the unit, use for map, compass, radio, watch, gps, and NVGs
		uniformItems[] = {{"ACE_morphine", 3}, {"ACE_epinephrine", 2}, {"ItemcTabHCam", 1}, {"ACE_quikclot", 10}, {"CUP_15Rnd_9x19_M9", 2}}; // Items to place in uniform. Includes weapon magazines
		vestItems[] = {{"SmokeShell", 2}, {"ACE_M84", 2}, {"hlc_30rnd_556x45_EPR", 4}, {"ACE_CableTie", 3}, {"ACE_tourniquet", 1}}; // Items to place in vest. Includes weapon magazines
		backpackItems[] = {{"hlc_30rnd_556x45_EPR", 4}}; // Items to place in backpack. Includes weapon magazines
	};
	...
	class B_Helipilot_F
	{
		...
		linkedItems[] = {"ItemMap", "ItemCompass", "ItemWatch", "ItemRadio", "ItemMicroDAGR"}; // Linked items for the unit, use for map, compass, radio, watch, gps, and NVGs
		uniformItems[] = {{"ACE_morphine", 3}, {"ACE_epinephrine", 3}, {"ItemcTabHCam", 1}, {"ACE_quikclot", 10}, {"CUP_15Rnd_9x19_M9", 1}}; // Items to place in uniform. Includes weapon magazines

...
class loadouts
{
	...
	class RM_SWAT_Chief_01
	{
		...
		primaryWeaponItems[] = {"CUP_30Rnd_556x45_Stanag", "CUP_acc_Flashlight", "FHQ_optic_AC12136"}; // Primary weapon items. Includes magazine you want loaded initially
		...
		uniformItems[] = {{"ACE_morphine", 3}, {"ACE_epinephrine", 2}, {"ItemcTabHCam", 1}, {"ACE_quikclot", 10}, {"hlc_10Rnd_357SIG_B_P229", 2}}; // Items to place in uniform. Includes weapon magazines
		vestItems[] = {{"SmokeShell", 2}, {"ACE_M84", 2}, {"CUP_30Rnd_556x45_Stanag", 5}, {"ACE_CableTie", 3}, {"ACE_tourniquet", 1}}; // Items to place in vest. Includes weapon magazines
	...
	class B_Soldier_TL_F
	{
		...
		linkedItems[] = {"ItemMap", "ItemCompass", "ItemWatch", "ItemRadio", "ItemMicroDAGR"}; // Linked items for the unit, use for map, compass, radio, watch, gps, and NVGs
		uniformItems[] = {{"ACE_morphine", 3}, {"ACE_epinephrine", 2}, {"ItemcTabHCam", 1}, {"ACE_quikclot", 10}, {"hlc_10Rnd_357SIG_B_P229", 2}}; // Items to place in uniform. Includes weapon magazines
		vestItems[] = {{"SmokeShell", 2}, {"ACE_M84", 2}, {"CUP_30Rnd_556x45_Stanag", 4}, {"ACE_CableTie", 3}, {"ACE_tourniquet", 1}}; // Items to place in vest. Includes weapon magazines
		backpackItems[] = {{"CUP_30Rnd_556x45_Stanag", 4}}; // Items to place in backpack. Includes weapon magazines
	};
	...
	class B_Soldier_F
	{
		...
		linkedItems[] = {"ItemMap", "ItemCompass", "ItemWatch", "ItemRadio", "ItemMicroDAGR"}; // Linked items for the unit, use for map, compass, radio, watch, gps, and NVGs
		uniformItems[] = {{"ACE_morphine", 3}, {"ACE_epinephrine", 2}, {"ItemcTabHCam", 1}, {"ACE_quikclot", 10}, {"hlc_10Rnd_357SIG_B_P229", 2}}; // Items to place in uniform. Includes weapon magazines
		vestItems[] = {{"SmokeShell", 2}, {"ACE_M84", 2}, {"CUP_30Rnd_556x45_Stanag", 7}, {"ACE_CableTie", 3}, {"ACE_tourniquet", 1}}; // Items to place in vest. Includes weapon magazines
		backpackItems[] = {}; // Items to place in backpack. Includes weapon magazines
	};
	...
	class B_soldier_exp_F
	{
		...
		linkedItems[] = {"ItemMap", "ItemCompass", "ItemWatch", "ItemRadio", "ItemMicroDAGR"}; // Linked items for the unit, use for map, compass, radio, watch, gps, and NVGs
		uniformItems[] = {{"ACE_morphine", 3}, {"ACE_epinephrine", 3}, {"ItemcTabHCam", 1}, {"ACE_quikclot", 10}, {"hlc_10Rnd_357SIG_B_P229", 1}, {"hlc_30Rnd_9x19_B_MP5", 1}}; // Items to place in uniform. Includes weapon magazines
		vestItems[] = {{"SmokeShell", 2}, {"ACE_M84", 1}, {"ACE_tourniquet", 1}, {"ACE_CableTie", 3}, {"hlc_30Rnd_9x19_B_MP5", 3}, {"hlc_30Rnd_9x19_GD_MP5", 2}, {"ACE_DefusalKit", 1}, {"ACE_Clacker", 1}, {"DemoCharge_Remote_Mag", 2}, {"ACE_wirecutter", 1}}; // Items to place in vest. Includes weapon magazines
		backpackItems[] = {}; // Items to place in backpack. Includes weapon magazines
	};
	...
	{
		displayName = "SWAT Sheidl Man (Red)"; // Currently unused, basically just a human-readable name for the loadout
	...
	{
		displayName = "SWAT Shield Man (Blue)"; // Currently unused, basically just a human-readable name for the loadout
	...
	class B_Soldier_lite_F
	{
		...
		linkedItems[] = {"ItemMap", "ItemCompass", "ItemWatch", "ItemRadio", "ItemMicroDAGR"}; // Linked items for the unit, use for map, compass, radio, watch, gps, and NVGs
		uniformItems[] = {{"ACE_morphine", 3}, {"ACE_epinephrine", 2}, {"ItemcTabHCam", 1}, {"ACE_quikclot", 10}, {"hlc_10Rnd_357SIG_B_P229", 2}}; // Items to place in uniform. Includes weapon magazines
		vestItems[] = {{"SmokeShell", 2}, {"ACE_M84", 2}, {"hlc_10rnd_12g_buck_S12", 4}, {"hlc_10rnd_12g_slug_S12", 4}, {"ACE_CableTie", 3}, {"ACE_tourniquet", 1}}; // Items to place in vest. Includes weapon magazines
		backpackItems[] = {}; // Items to place in backpack. Includes weapon magazines
	};
	...
	class B_Helipilot_F
	{
		displayName = "SWAT Pilot"; // Currently unused, basically just a human-readable name for the loadout
		...
		linkedItems[] = {"ItemMap", "ItemCompass", "ItemWatch", "ItemRadio", "ItemMicroDAGR"}; // Linked items for the unit, use for map, compass, radio, watch, gps, and NVGs
		uniformItems[] = {{"ACE_morphine", 3}, {"ACE_epinephrine", 3}, {"ItemcTabHCam", 1}, {"ACE_quikclot", 10}, {"hlc_10Rnd_357SIG_B_P229", 1}}; // Items to place in uniform. Includes weapon magazines
		vestItems[] = {{"SmokeShell", 2}, {"ACE_M84", 2}, {"ACE_tourniquet", 1}, {"ACE_CableTie", 3}, {"hlc_30Rnd_9x19_B_MP5", 3}}; // Items to place in vest. Includes weapon magazines
		backpackItems[] = {}; // Items to place in backpack. Includes weapon magazines
	};
};
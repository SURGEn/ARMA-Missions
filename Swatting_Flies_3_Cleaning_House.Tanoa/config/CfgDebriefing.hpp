...
class cfgDebriefing
{
	...
	class heliShotDown
	{
		title = "TO BE CONTINUED"; // Main text that appears for the closing shot (ex: MISSION COMPLETED)
		subtitle = ""; // Subtitle below the title when the closing shot is triggered
		description = ""; // Description visible on the debriefing screen after the closing shot
		//pictureBackground = ""; // Image file used as a background on the debriefing screen
		//picture = ""; // Icon used for the closing shot
		//pictureColor[] = {1,1,1,1}; // Colour of the icon during the closing shot. Leave as default most of the time
	};

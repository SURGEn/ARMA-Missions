...
player createDiaryRecord ["zeusmenu", ["HeadlessClient",
	"<executeClose expression='[true] call SXP_fnc_hcCuratorEnable'>Enable curator unit transfer</execute>
	<br/><executeClose expression='[false] call SXP_fnc_hcCuratorEnable'>Disable curator unit transfer</execute>
	<br/>"
]];
